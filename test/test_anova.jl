@testset "ANOVA Tests" begin
    @testset "Multidimensional Array" begin
        @testset "1-way ANOVA" begin
            expected = [AnovaValue( "Total", 4822.4575, 19),
                        AnovaResult(    "A", 4684.9975,  3, 1561.66583, 181.773995, 1.43627554e-12, 0),
        ...
        @testset "2-way ANOVA without replicates" begin
            ...
            expected = [AnovaValue(     "Total", 5594.9167,  11),
                        AnovaResult(        "A", 1116.91667,  3,  372.30556,  2.6316513, 0.144561215, 0),
                        AnovaResult(        "B", 3629.1667,   2, 1814.58333, 12.8264284, 0.0068110648, 0),
        ...
        @testset "3-way ANOVA" begin
            ...
            @testset "All Fixed" begin
                expected = [AnovaValue(     "Total", 30.355,       71),
                            AnovaResult(        "A",  1.8175,       2,  0.90875,      24.475062,    2.71459995e-8, 0),
                            AnovaResult(        "B", 24.655833,     2, 12.3279167,   332.02369,     4.5550981e-31, 0),
                            AnovaResult(        "C",  0.008888889,  1,  0.008888889,   0.239401496, 0.62662035, 0),
                            AnovaResult(    "A × B",  1.10166667,   4,  0.27541667,    7.4177057,   7.7516681e-5, 0),
                            AnovaResult(    "A × C",  0.37027778,   2,  0.18513889,    4.9862843,   0.0102990988, 0),
                            AnovaResult(    "B × C",  0.17527778,   2,  0.08763889,    2.3603491,   0.104056404, 0),
                            AnovaResult("A × B × C",  0.220555556,  4,  0.055138889,   1.4850374,   0.21958095, 0),
            ...
            @testset "All Random" begin
                expected = [AnovaValue(     "Total", 30.355,       71),
                            AnovaResult(        "A",  1.8175,       2,  0.90875,      4.1754946,   0.179725175, 0),
                            AnovaResult(        "B", 24.655833,     2, 12.3279167,   40.036536,    0.0022084069, 0),
                            AnovaResult(        "C",  0.008888889,  1,  0.008888889,  0.021925317, 0.88874495, 0),
                            AnovaResult(    "A × B",  1.10166667,   4,  0.27541667,   4.9949622,   0.074190827, 0),
                            AnovaResult(    "A × C",  0.37027778,   2,  0.18513889,   3.3576826,   0.139349696, 0),
                            AnovaResult(    "B × C",  0.17527778,   2,  0.08763889,   1.58942065,  0.31046402, 0),
                            AnovaResult("A × B × C",  0.220555556,  4,  0.055138889,  1.4850374,   0.21958095, 0),
                            AnovaFactor(    "Error",  2.005,       54,  0.03712963)]
            ...
            @testset "1 random, 2 fixed" begin
                expected = [AnovaValue(     "Total", 30.355,       71),
                            AnovaResult(        "A",  1.8175,       2,  0.90875,      4.9084771,   0.16924835, 0),
                            AnovaResult(        "B", 24.655833,     2, 12.3279167,   44.760968,    0.001829334, 0),
                            AnovaResult(        "C",  0.008888889,  1,  0.008888889,  0.239401496, 0.62662035, 0),
                            AnovaResult(    "A × B",  1.10166667,   4,  0.27541667,   4.9949622,   0.074190827, 0),
                            AnovaResult(    "A × C",  0.37027778,   2,  0.18513889,   4.9862843,   0.0102990988, 0),
                            AnovaResult(    "B × C",  0.17527778,   2,  0.08763889,   2.3603491,   0.104056404, 0),
            ...
            @testset "2 random, 1 fixed" begin
                expected = [AnovaValue(     "Total", 30.355,       71),
                            AnovaResult(        "A",  1.8175,       2,  0.90875,      4.1754946,    0.179725175, 0),
                            AnovaResult(        "B", 24.655833,     2, 12.3279167,   44.760968,    0.001829334, 0),
                            AnovaResult(        "C",  0.008888889,  1,  0.008888889,  0.032274332, 0.8661604, 0),
                            AnovaResult(    "A × B",  1.10166667,   4,  0.27541667,   4.9949622,   0.074190827, 0),
                            AnovaResult(    "A × C",  0.37027778,   2,  0.18513889,   3.3576826,   0.139349696, 0),
                            AnovaResult(    "B × C",  0.17527778,   2,  0.08763889,   2.3603491,   0.104056404, 0),
                            AnovaResult("A × B × C",  0.220555556,  4,  0.055138889,  1.4850374,   0.21958095, 0),
    ...
    @testset "DataFrame" begin
        ...
        expected = [AnovaValue(                       "Total", 30.355,       71),
                    AnovaResult(                    "FactorA",  1.8175,       2,  0.90875,      24.475062,    2.71459995e-8, 0),
                    AnovaResult(                    "FactorB", 24.655833,     2, 12.3279167,   332.02369,     4.5550981e-31, 0),
                    AnovaResult(                    "FactorC",  0.008888889,  1,  0.008888889,   0.239401496, 0.62662035, 0),
                    AnovaResult(          "FactorA × FactorB",  1.10166667,   4,  0.27541667,    7.4177057,   7.7516681e-5, 0),
                    AnovaResult(          "FactorA × FactorC",  0.37027778,   2,  0.18513889,    4.9862843,   0.0102990988, 0),
                    AnovaResult(          "FactorB × FactorC",  0.17527778,   2,  0.08763889,    2.3603491,   0.104056404, 0),
                    AnovaResult("FactorA × FactorB × FactorC",  0.220555556,  4,  0.055138889,   1.4850374,   0.21958095, 0),
                    AnovaFactor(                      "Error",  2.005,       54,  0.03712963)]
